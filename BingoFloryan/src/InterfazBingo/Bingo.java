...
public class Bingo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label1.setText("Bienvenidos Al Nuevo Tico Bingo Virtual 2022");

        jScrollPane1.setViewportView(jTextPane1);
        jTextPane1.getAccessibleContext().setAccessibleName("Cantor");

        button1.setLabel("Generar Numero");
    ...
    private void button1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button1MouseClicked
        ...
        String contador;
        contador=jTextPane1.getText();
        jTextPane1.setText(contador+", "+Integer.toString(n.Numeros()));
